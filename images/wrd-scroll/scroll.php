<?
Set $datadate("n/j/Y g:i:s A") = Server.CreateObject("ADODB.Connection"); 
$datadate("n/j/Y g:i:s A").$Open["Driver={MySQL ODBC 3.51 Driver};Server=localhost;DATABASE=wrd-test;USER=root;PASSWORD=aslangs;OPTION=3"];
$datadate("n/j/Y g:i:s A").execute("SET NAMES 'utf8'");
